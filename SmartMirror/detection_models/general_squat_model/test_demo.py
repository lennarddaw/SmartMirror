...
ANNOTATED_DIR = 'squat_output_videos/annotated'
PLOT_DIR = 'squat_output_videos/plots'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="rep_segmenter_squat.keras", help="Path to model")
