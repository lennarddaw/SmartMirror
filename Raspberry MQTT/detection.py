...
STREAM_URL = 'http://192.168.168.63/stream'

pushup_count = 0,
stage = None

def detect_pushup(landmarks, h):
    ...
    if avg_shoulder_y > down_threshold:
        stage = "down"
    elif avg_shoulder_y < up_threshold and stage == "down":
        stage = "up"
        pushup_count += 1
